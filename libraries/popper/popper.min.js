          ...
          if (((e = e.name), !t.modifiersData[e]._skip)) {
            ...
            for (var d = c[0], l = 0; l < c.length; l++) {
              ...
              if (
                ...
                n[y] > r[y] && (v = j(v)),
                (y = j(v)),
                (h = [0 >= w[h], 0 >= w[v], 0 >= w[y]]).every(function(e) {
                  return e;
                }))
              ) {
                (d = m), (p = !1);
      ...
      },
      {
        ...
        fn: function(e) {
          ...
          if (((s = { x: 0, y: 0 }), o)) {
            ...
            (g = D[g]),
              (y = D[y]),
              (m = Math.max(0, Math.min(l[w], m[w]))),
              (E = p ? l[w] / 2 - j - m - g - v : E - m - g - v),
              (p = p ? -l[w] / 2 + j + m + y + v : f + m + y + v),
              (v = t.elements.arrow && h(t.elements.arrow)),
              ...
              (v =
                ...
                E -
                l -
                (v ? ("y" === u ? v.clientTop || 0 : v.clientLeft || 0) : 0)),
              (p = d[u] + p - l),
              (i = Math.max(
                i ? Math.min(O, v) : O,
                  ...
                  (u / 2 -
                    ...
                    (d
                      ? "y" === a
                        ...
                        : d.clientTop || 0
                      : 0)),
                r.rects.popper[i] - n[i] - s[p]
              )
            )),
              (r.modifiersData[e] = (((t = {})[a] = i), t));
          }
        },
        effect: function(e) {
          var t = e.state,
